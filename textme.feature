Feature: ###JIRA Ticket Number### As a ABCGroceryStore mobile app customer having OTP Enabled and I want to perfrom a High Risk Transaction and verify it is Routed through On text OTP Interdiction Scree.
...
Scenario Outline: '<FOLB Customer>' should see Interdiction Screen In case he is perfroming a High Risk Transaction
    ...
    Examples:
        ...
        | Interdiction User 2  | Account Unmask - View Acct#    | We'll text you with one-time code.  |
        | Interdiction User 3  | Account Unmask - View Acct#    | We'll text you with one-time code.  |
        | Interdiction User 1  | Rewards - Consumer in-session  | We'll text you with one-time code.  |
        | Interdiction User 2  | Rewards - Consumer in-session  | We'll text you with one-time code.  |
        | Interdiction User 3  | Rewards - Consumer in-session  | We'll text you with one-time code.  |
...
Scenario Outline: '<FOLB Customer>' perfroming a High Risk Transaction and Having Default SMS OTP as Interdiction Method, click close button(X on top right of screen), Intediction Screen Should Close.
    ...
    Examples:
        ...
        | Interdiction User 2  | Account Unmask - View Acct#    | We'll text you with one-time code.  | (...) ... - 1234  |
        | Interdiction User 3  | Account Unmask - View Acct#    | We'll text you with one-time code.  | (...) ... - 1234  |
        | Interdiction User 1  | Rewards - Consumer in-session  | We'll text you with one-time code.  | (...) ... - 1234  |
        | Interdiction User 2  | Rewards - Consumer in-session  | We'll text you with one-time code.  | (...) ... - 1234  |
        | Interdiction User 3  | Rewards - Consumer in-session  | We'll text you with one-time code.  | (...) ... - 1234  |

# Screen Object/User Interface Testing - Verify that all the Controls/labels/images/objects are present on screen
Scenario Outline: '<FOLB Customer>' perfroming a High Risk Transaction and Having Default text OTP Interdiction Method, I should see all the Controls/labels/images/objects On Screen.
    Given I am logged in to ABCGroceryStore Online Banking as '<FOLB Customer>'
    When I navigate to '<Control Point>' page
...
Scenario Outline: '<FOLB Customer>' perfroming a High Risk Transaction and Having Default text OTP Interdiction Method, I should see all the Controls/labels/images/objects On Screen.
    ...
    Examples:
        ...
        | Interdiction User 2  | Account Unmask - View Acct#  | We'll text you with one-time code.  | By continuing, you agree that we can send you the code using the number you select.  |  Message and data rates may apply.  | Select one           | Try Another Method   |
...
Scenario Outline: '<FOLB Customer>' perfroming a High Risk Transaction and Having Default text OTP Interdiction Method, I should see all the Controls/labels/images/objects On Screen.
    ...
    Examples:
        ...
        | Interdiction User 3  | Account Unmask - View Acct#  | We'll text you with one-time code.  | By continuing, you agree that we can send you the code using the number you select.  |  Message and data rates may apply.  | Select one           |
...
Given I am logged in to ABCGroceryStore Online Banking as '<FOLB Customer>'
    ...
    Examples:
        ...
        | Interdiction User 2  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | A code was sent to (...) ... - 3859 by text message.  | OTP Textbox          |
        | Interdiction User 3  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | A code was sent to (...) ... - 3859 by text message.  | OTP Textbox          |
...
Given I am logged in to ABCGroceryStore Online Banking as '<FOLB Customer>'
    ...
    Then I should see the '<On Screen Control 3>' as '<Continue Button Status>'
        ...
        | Interdiction User 2  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 123       | disabled               |
        | Interdiction User 3  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 123       | disabled               |
        | Interdiction User 1  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 123456    | enabled                |
        | Interdiction User 2  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 123456    | enabled                |
        | Interdiction User 3  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 123456    | enabled                |
        | Interdiction User 1  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 12345678  | enabled                |
        | Interdiction User 2  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 12345678  | enabled                |
        | Interdiction User 3  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 12345678  | enabled                |
...
Given I am logged in to ABCGroceryStore Online Banking as '<FOLB Customer>'
    ...
    Examples:
        ...
        | Interdiction User 2  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 123       | 3                | 123                 |
        | Interdiction User 3  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 123       | 3                | 123                 |
        | Interdiction User 1  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 123456    | 6                | 123456              |
        | Interdiction User 2  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 123456    | 6                | 123456              |
        | Interdiction User 3  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 123456    | 6                | 123456              |
        | Interdiction User 1  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 12345678  | 6                | 123456              |
        | Interdiction User 2  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 12345678  | 6                | 123456              |
        | Interdiction User 3  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 12345678  | 6                | 123456              |
        | Interdiction User 1  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 123a      | 3                | 123                 |
        | Interdiction User 2  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 123a      | 3                | 123                 |
        | Interdiction User 3  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 123a      | 3                | 123                 |
        | Interdiction User 1  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 12bc5634  | 6                | 125634              |
        | Interdiction User 2  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 12bc5634  | 6                | 125634              |
        | Interdiction User 3  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | 12bc5634  | 6                | 125634              |
        | Interdiction User 1  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | a234567b  | 6                | 234567              |
        | Interdiction User 2  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | a234567b  | 6                | 234567              |
        | Interdiction User 3  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | a234567b  | 6                | 234567              |
        | Interdiction User 1  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | #234%67$  | 5                | 23467               |
        | Interdiction User 2  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | #234%67$  | 5                | 23467               |
        | Interdiction User 3  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | Enter code           | OTP Textbox         | #234%67$  | 5                | 23467               |
...
Scenario Outline: '<FOLB Customer>' should see error popup In case he is perfroming a High Risk Transaction and Eligible for SMS OTP and entering wrong OTP
    Given I am logged in to ABCGroceryStore Online Banking as '<FOLB Customer>'
    When I navigate to '<Control Point>' page
    ...
    Then I should see the '<On Screen Label>' label
    Examples:
        | FOLB Customer        | Control Point                | On Screen Label 1                   | Mobile Number     | On Screen Control   | Wrong OTP       | Modal Header Text | Modal Body Text                                                                                     |
        | Interdiction User 1  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | OTP Textbox         | 123456          | Let's try again   | The code you've entered isn't correct. |
        | Interdiction User 2  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | OTP Textbox         | 123456          | Let's try again   | The code you've entered isn't correct. |
        | Interdiction User 3  | Account Unmask - View Acct#  | We'll text you with one-time code.  | (...) ... - 1234  | OTP Textbox         | 123456          | Let's try again   | The code you've entered isn't correct. |


Scenario Outline: '<FOLB Customer>' perfroming a High Risk Transaction and Having SMS OTP as Interdiction Method, enters incorrect OTP and later again enters incorrect OTP
    Given I am logged in to ABCGroceryStore Online Banking as '<FOLB Customer>'
    When I navigate to '<Control Point>' page
    Then I should see the '<On Screen Label 1>' label
    When I click on "<Mobile Number>" from Moblile Number list
...
Scenario Outline: '<FOLB Customer>' perfroming a High Risk Transaction and Having SMS OTP as Interdiction Method, and requests for new OTP and enters it incorrectly.
    Given I am logged in to ABCGroceryStore Online Banking as '<FOLB Customer>'
    When I navigate to '<Control Point>' page
    Then I should see the '<On Screen Label 1>' label
    When I click on "<Mobile Number>" from Moblile Number list
...
Scenario Outline: '<FOLB Customer>' perfroming a High Risk Transaction and Having SMS OTP as Interdiction Method, and requests for new OTP and enters previous OTP.
    Given I am logged in to ABCGroceryStore Online Banking as '<FOLB Customer>'
    When I navigate to '<Control Point>' page
    Then I should see the '<On Screen Label 1>' label
    When I click on "<Mobile Number>" from Moblile Number list
