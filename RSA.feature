...
# 5) with RSA Auth Enabled and No other Auth Enabled
...
Scenario Outline: '<FOLB Customer>' "Try Another Menthod" Button should not be present In case he is perfroming a High Risk Transaction and Eligible only for 1 Auth - RSA
    Given I am logged in to ABCGroceryStore Online Banking as '<FOLB Customer>'
    When I navigate to '<Control Point>' page
    Then I should see the '<On Screen Label>' label
    ...
    Examples:
        | FOLB Customer        | Control Point                  | On Screen Label                               |
        | Interdiction User 5  | Account Unmask - View Acct#    | Enter the code from your RSA SecureID device  |
        | Interdiction User 5  | Rewards - Consumer in-session  | Enter the code from your RSA SecureID device  |
...
Scenario Outline: '<FOLB Customer>' while perfroming a High Risk Transaction and Eligible for RSA, user should not be able to enter more than 6 digits and alphabets/special chars.
Given I am logged in to ABCGroceryStore Online Banking as '<FOLB Customer>'
    When I navigate to '<Control Point>' page
    ...
    Examples:
        ...
        | Interdiction User 1  | Account Unmask - View Acct#  | Device Code Textbox | #234%67$  | 5                | 23467               |
        | Interdiction User 4  | Account Unmask - View Acct#  | Device Code Textbox | #234%67$  | 5                | 23467               |
